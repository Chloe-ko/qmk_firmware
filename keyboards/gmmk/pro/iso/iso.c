...
led_config_t g_led_config = {{
    { 4,      NO_LED, NO_LED, 80, 65, 72, 5,      28 },
    { 8,      2,      9,      0,  10, 70, 1,      7  },
    { 14,     3,      15,     67, 16, 75, 6,      13 },
    { 20,     18,     21,     23, 22, 78, 12,     19 },
    { 25,     30,     26,     31, 27, 32, 29,     24 },
    { 41,     36,     42,     37, 43, 38, 35,     40 },
    { 46,     76,     47,     34, 48, 69, 71,     45 },
    { 52,     39,     53,     82, 54, 73, 44,     51 },
    { 58,     63,     59,     64, 79, 60, 62,     57 },
    { 11,     77,     55,     17, 33, 49, NO_LED, 68 },
    { NO_LED, 74,     NO_LED, 61, 81, 66, 50,     56 }
}, {
    {0, 0},     // 0, ESC, k13
    {0, 15},    // 1, `, k16
    {4, 26},    // 2, Tab, k11
...
const aw_led g_aw_leds[DRIVER_LED_TOTAL] = {
    ...
    {1, CS4_SW2, CS5_SW2, CS6_SW2},     //  68, Prt, k97
    {1, CS4_SW3, CS5_SW3, CS6_SW3},     //  69, Del, k65
    {1, CS4_SW4, CS5_SW4, CS6_SW4},     //  70, PgUp, k15
    {1, CS1_SW5, CS2_SW5, CS3_SW5},     //  71, =, k66
    {1, CS10_SW5, CS11_SW5, CS12_SW5},  //  72, Right, k05
    {1, CS4_SW6, CS5_SW6, CS6_SW6},     //  73, End, k75
    {1, CS1_SW7, CS2_SW7, CS3_SW7},     //  74, BSpc, ka1
    {1, CS4_SW7, CS5_SW7, CS6_SW7},     //  75, PgDn, k25
    {1, CS1_SW8, CS2_SW8, CS3_SW8},     //  76, ], k61
    {1, CS4_SW8, CS5_SW8, CS6_SW8},     //  77, Sh_R, k91
    {1, CS4_SW9, CS5_SW9, CS6_SW9},     //  78, Up, k35
    {1, CS1_SW10, CS2_SW10, CS3_SW10},  //  79, #, k84
    {1, CS4_SW10, CS5_SW10, CS6_SW10},  //  80, Left, k03
    {1, CS1_SW11, CS2_SW11, CS3_SW11},  //  81, Enter, ka4
    {1, CS4_SW11, CS5_SW11, CS6_SW11},  //  82, Down, k73
    {1, CS13_SW1, CS14_SW1, CS15_SW1},  //  83, LED, l01
    {1, CS16_SW1, CS17_SW1, CS18_SW1},  //  84, LED, l11
    {1, CS13_SW2, CS14_SW2, CS15_SW2},  //  85, LED, l02
    {1, CS16_SW2, CS17_SW2, CS18_SW2},  //  86, LED, l12
    {1, CS13_SW3, CS14_SW3, CS15_SW3},  //  87, LED, l03
    {1, CS16_SW3, CS17_SW3, CS18_SW3},  //  88, LED, l13
    {1, CS13_SW4, CS14_SW4, CS15_SW4},  //  89, LED, l04
    {1, CS16_SW4, CS17_SW4, CS18_SW4},  //  90, LED, l14
    {1, CS13_SW5, CS14_SW5, CS15_SW5},  //  91, LED, l05
    {1, CS16_SW5, CS17_SW5, CS18_SW5},  //  92, LED, l15
    {1, CS13_SW6, CS14_SW6, CS15_SW6},  //  93, LED, l06
    {1, CS16_SW6, CS17_SW6, CS18_SW6},  //  94, LED, l16
    {1, CS13_SW7, CS14_SW7, CS15_SW7},  //  95, LED, l07
    {1, CS16_SW7, CS17_SW7, CS18_SW7},  //  96, LED, l17
    {1, CS13_SW8, CS14_SW8, CS15_SW8},  //  97, LED, l08
    {1, CS16_SW8, CS17_SW8, CS18_SW8},  //  98, LED, l18
};
// clang-format on
#endif
