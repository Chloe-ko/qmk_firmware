 ...
 */
    ...
    enum led_location_map {
        ...
        LED_F12, // 66, F12, ka5
        LED_DEL, // 67, Prt, k97  -- remapped to DEL
        LED_HOME, // 68, Del, k65 -- remapped to HOME
        LED_EQL, // 69, =, k66
        LED_RIGHT, // 70, Right, k05
        LED_PGUP, // 71, PgUp, k15
        LED_END, // 72, End, k75
        LED_BSPC, // 73, BSpc, ka1
        LED_PGDN, // 74, PgDn, k25
        LED_RBRC, // 75, ], k61
        LED_RSFT, // 76, Sh_R, k91
        LED_BSLS, // 77, \, ka2
        LED_UP, // 78, Up, k35
